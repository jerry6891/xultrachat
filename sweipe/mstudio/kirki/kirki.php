...
include_once( get_template_directory() . DIRECTORY_SEPARATOR . 'mstudio' . DIRECTORY_SEPARATOR . 'kirki' . DIRECTORY_SEPARATOR . 'autoloader.php' );
...
foreach ( $files as $file ) {
	if ( file_exists( get_template_directory() . DIRECTORY_SEPARATOR . 'mstudio' . DIRECTORY_SEPARATOR . 'kirki' . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . $file ) ) {
		include_once( get_template_directory() . DIRECTORY_SEPARATOR . 'mstudio' . DIRECTORY_SEPARATOR . 'kirki' . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR . $file );
	}
}
...
if ( ! function_exists( 'Kirki' ) ) {
	...
	function Kirki() {
		 ...
		 */
		Kirki::$path = get_template_directory() . DIRECTORY_SEPARATOR . 'mstudio' . DIRECTORY_SEPARATOR . 'kirki';
